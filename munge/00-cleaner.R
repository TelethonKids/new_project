...
# dat_raw <- read_csv(file = "data-raw/data_dictionary.csv", col_types = cols(.default = "c"))
dict <- read_xlsx("data-raw/data_dictionary.xlsx", sheet = "Data Dictionary", col_types = c("text"))

#### Data cleaning ----

# dat_raw <- clean_REDCap(dat_raw, dictionary)
